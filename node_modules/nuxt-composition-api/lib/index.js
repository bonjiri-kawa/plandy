...
import { mkdirpSync, existsSync, readdirSync, copyFileSync } from 'fs-extra';
...
const compositionApiModule = function () {
    ...
    const { dst: entryDst } = this.addTemplate({
        ...
        options: {
            ...
            publicPath: normalize(join(((_c = this.options.router) === null || _c === void 0 ? void 0 : _c.base) || '', '/')),
            globalContext,
            globalNuxt,
        },
    });
...
export { defineComponent, defineNuxtMiddleware, defineNuxtModule, defineNuxtPlugin, defineNuxtServerMiddleware, globalPlugin, meta, onGlobalSetup, setSSRContext, shallowSsrRef, ssrPromise, ssrRef, useAsync, useContext, useFetch, useMeta, useStatic, withContext };
