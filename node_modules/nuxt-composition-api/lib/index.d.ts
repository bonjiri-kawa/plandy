import { Ref, defineComponent as defineComponent$1, getCurrentInstance, SetupContext, UnwrapRef } from '@vue/composition-api';
export { ComponentRenderProxy, ComputedRef, FlushMode, InjectionKey, PropOptions, PropType, Ref, SetupContext, UnwrapRef, VueWatcher, WatchCallback, WatchEffect, WatchOptions, WatchOptionsBase, WatchSource, WatchStopHandle, WritableComputedRef, computed, createComponent, createElement, getCurrentInstance, inject, isReactive, isRef, markRaw, nextTick, onActivated, onBeforeMount, onBeforeUnmount, onBeforeUpdate, onDeactivated, onErrorCaptured, onMounted, onServerPrefetch, onUnmounted, onUpdated, provide, reactive, ref, set, shallowReactive, shallowRef, toRaw, toRef, toRefs, triggerRef, unref, watch, watchEffect } from '@vue/composition-api';
import { Context, Plugin, Middleware, Module, ServerMiddleware } from '@nuxt/types';
...
declare type ComponentInstance = NonNullable<ReturnType<typeof getCurrentInstance>>;
interface Fetch {
 ...
 */
declare const useMeta: <T extends MetaInfo>(init?: T | undefined) => ToRefs<MetaInfoMapper<Required<MetaInfo>> & T>;

declare function setSSRContext(ssrContext: any): void;
/**
 ...
 * @example
  ...
  ```
 */
declare const ssrRef: <T>(value: T | (() => T), key?: string | undefined) => Ref<UnwrapRef<T>>;
/**
...
declare const defineNuxtModule: <T extends Record<string, unknown>>(module: Module<T>) => Module<T>;
declare const defineNuxtServerMiddleware: (serverMiddleware: ServerMiddleware) => NextHandleFunction;
